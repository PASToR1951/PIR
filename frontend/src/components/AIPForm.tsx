...
const TextareaAuto = ({ className = "", ...props }: any) => {
...
export default function AIPForm({ schoolId, schoolName, onBack }: AIPFormProps) {
                            ...
                            <div className={`${currentStep === 3 ? 'block animate-in fade-in slide-in-from-bottom-4 duration-500' : 'hidden'}`}>
                                ...
                                <div className="mt-8 flex justify-center">
                                    <button
                                        ...
                                        className={`group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-2xl px-8 font-bold shadow-sm border-2 active:scale-95 transition-colors gap-2 duration-300 ${isAddingActivity
